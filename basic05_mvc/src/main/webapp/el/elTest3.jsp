...
<%
	...
	pageContext.setAttribute("kor", 100);	//elTest3.jsp 현재 페이지에서만 유효하다
...
%>
	...
	<!-- EL에서는 없으면 다음으로 있으면 멈춤 page -> request -> session application 순으로 자동으로 검색 -->
	kor :${kor}<br>
	eng :${eng}<br>
	mat :${mat}<br>
	aver :${aver}<br>
