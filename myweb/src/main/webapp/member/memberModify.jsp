...
<tr>
    ...
    <td style="text-align: left">
    	<input style='background: rgba(10, 0, 0, 0.15)' type="text" name="id" id="id" size="10" maxlength="10" readonly value="<%=dto.getId()%>">
    	<input type="button" value="ID수정" onclick="idCheck()"> <!-- myscript.js -->
    </td>
</tr>
<tr>
    <th>*비밀번호</th>
...
<tr>
    <th>*이름</th>
    <td style="text-align: left">
    	<input type="text" name="mname" id="mname" size="10" maxlength="20" required value="<%=dto.getMname()%>">
    </td>
</tr>
<tr>
    <th>*이메일</th>
    <td style="text-align: left">
    	<input style='background: rgba(10, 0, 0, 0.15)' type="text" name="email" id="email" size="22" maxlength="50" readonly value="<%=dto.getEmail()%>">
    	<input type="button" value="Email수정" onclick="emailCheck()"> <!-- myscript.js -->
    </td>
</tr>
<tr>
    <th>전화번호</th>
...
<tr>
    <th>우편번호</th>
    <td style="text-align: left">
      <input style='background: rgba(10, 0, 0, 0.15)' type="text" name="zipcode" id="zipcode" size="7"  readonly value="<%=dto.getZipcode()%>">
...
<tr>  
    <th>주소</th>
    <td style='text-align: left;'>
    	<input style='background: rgba(10, 0, 0, 0.15)' type="text" name="address1" id="address1" size="45" readonly value="<%=dto.getAddress1() %>">
    </td>
</tr>
<tr>  
    <th>나머지주소</th>
