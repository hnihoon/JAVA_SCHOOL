...
/* 	
	...
	※ 2) 참조 : http://www.servlets.com/cos/
*/
	...
	try{
		...
		//실행결과 = D:\java202307\java\workspace\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\myweb\storage
		...
		String encoding="UTF-8";
										//정보를 가지고있는 변수, 저장할 위치, 저장 용량 지정, 인코딩방식, 파일이름 중복시 이름에 숫자를 올려주는 메서드)  
